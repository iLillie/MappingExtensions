...
adb push "build/libMappingExtensions.so" "/sdcard/ModData/$packageId/Modloader/mods/libMappingExtensions.so"
...
adb shell am start "$packageId/com.unity3d.player.UnityPlayerGameActivity"
